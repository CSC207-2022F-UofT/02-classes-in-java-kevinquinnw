...
public class Silly implements Comparable<Silly>{
     ...
     */
     ...
     /**
      * Sets our name attribute to the concatenation of the entered strings
      * @param first the first word of our sequence
      * @param second the second word of our sequence
      */
